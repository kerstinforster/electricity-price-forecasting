""" This class implements the Prophet model for predicting """
...
class ProphetModel(BaseModel):
    ...
    def __init__(self, model_params: dict, name: str = 'prophet'):
        """
        Constructor for the prophet model setting the name field and
        the specific model parameters
        :param name: name of the used algorithm, 'prophet'
